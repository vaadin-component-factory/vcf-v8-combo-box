...
@JavaScript("frontend://vcf-v8-comboBoxConnector.js")
@JsModule("./vcf-v8-comboBoxConnector-es6.js")
public class V8ComboBox<T> extends GeneratedV8VaadinComboBox<V8ComboBox<T>, T>
    ...
    private final class UpdateQueue implements Update {
        ...
        public void commit(int updateId) {
            enqueue("$connector.confirm", updateId, V8ComboBox.this.lastFilter);
    ...
    /**
     * Predicate to check {@link V8ComboBox} items against user typed strings.
     */
    @FunctionalInterface
    ...
    public V8ComboBox(int pageSize) {
        super(null, null, String.class, V8ComboBox::presentationToModel,
            V8ComboBox::modelToPresentation);
    ...
    private static <T> T presentationToModel(V8ComboBox<T> comboBox,
            String presentation) {
    ...
    private static <T> String modelToPresentation(V8ComboBox<T> comboBox,
            T model) {
        if (model == null) {
            return null;
        }
    ...
    public Registration addCustomValueSetListener(
            ComponentEventListener<CustomValueSetEvent<V8ComboBox<T>>> listener) {
    ...
    private void initConnector() {
        getElement().executeJs(
                "window.Vaadin.Flow.v8comboBoxConnector.initLazy(this)");
    }
