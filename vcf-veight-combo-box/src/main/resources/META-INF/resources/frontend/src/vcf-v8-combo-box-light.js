...
class ComboBoxLightElement extends
  ...
  static get template() {
    ...
    <vcf-v8-combo-box-dropdown-wrapper id="overlay" opened="[[opened]]" position-target="[[inputElement]]" renderer="[[renderer]]" _focused-index="[[_focusedIndex]]" _item-id-path="[[itemIdPath]]" _item-label-path="[[itemLabelPath]]" loading="[[loading]]" theme="[[theme]]">
    </vcf-v8-combo-box-dropdown-wrapper>
`;
  }

  static get is() {
    return 'vcf-v8-combo-box-light';
  }
