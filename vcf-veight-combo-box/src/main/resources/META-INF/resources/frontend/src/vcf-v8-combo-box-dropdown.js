...
$_documentContainer.innerHTML = `<dom-module id="vcf-v8-combo-box-overlay-styles" theme-for="vcf-v8-combo-box-overlay">
  <template>
    <style>
      :host {
...
class ComboBoxOverlayElement extends OverlayElement {
  static get is() {
    return 'vcf-v8-combo-box-overlay';
  }
...
class ComboBoxDropdownElement extends DisableUpgradeMixin(
  ...
  static get template() {
    ...
    <vcf-v8-combo-box-overlay id="overlay" hidden\$="[[hidden]]" opened="[[opened]]" template="{{template}}" style="align-items: stretch; margin: 0;" theme\$="[[theme]]">
      <slot></slot>
    </vcf-v8-combo-box-overlay>
`;
  }

  static get is() {
    return 'vcf-v8-combo-box-dropdown';
  }
